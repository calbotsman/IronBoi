  ...
  const system = [
    ...
    ...(options.toolsEnabled
      ? [
          ...
          "- If an adapt_plan result has proposalLocked with a lockReason naming missing fields, call adapt_plan again immediately in the same turn with those fields filled from the conversation — never end the turn presenting a locked proposal as if it were ready to approve. If the lockReason says not to retry, don't.",
